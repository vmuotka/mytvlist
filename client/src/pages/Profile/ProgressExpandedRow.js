...
const ProgressExpandedRow = ({ user, show, expanded }) => {
...
const connectedProgressExpandedRow = connect(mapProps)(ProgressExpandedRow)

export default connectedProgressExpandedRow