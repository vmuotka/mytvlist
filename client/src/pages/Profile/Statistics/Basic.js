...
const Basic = () => {
  ...
  return (
    <>
      <div className='w-full bg-gradient-to-t from-pink-500 to-pink-400  text-white px-6 py-4 grid sm:grid-cols-3 divide-white divide-y sm:divide-y-0 sm:divide-x shadow-xl rounded'>
