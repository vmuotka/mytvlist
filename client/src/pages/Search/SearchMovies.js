    ...
    return (
        <>
            <Form className='max-w-sm mb-4' onSubmit={handleSubmit}>
                <Heading className='text-center'>Search Movies</Heading>
                <div className='mb4'>
                    <InputField className='w-full' label='Search' type='text' value={form.searchword} onChange={handleChange} name='searchword' placeholder='eg. Shrek 2' />
                </div>
            </Form>
            ...
            <div className='max-w-xl mx-auto'>
                ...
                {
                    response.results.map((result) => <MovieCard className='mt-4' movie={result} key={result.info.id} />)
                }
